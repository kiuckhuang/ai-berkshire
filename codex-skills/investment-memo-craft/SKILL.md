...
- Use a simple title: `公司名（ticker）研究報告`. Avoid adding "四大師綜合" or "投資備忘錄" to the title unless the user asks for that framing.
- Use dated filenames for reports: `公司名研究報告-YYYYMMDD.md`.
...
- Use Chinese step headings for readability, for example "第一步：核心數據總覽", "第二步：生意本質分析", and "第八步：最終決策與行動清單".
